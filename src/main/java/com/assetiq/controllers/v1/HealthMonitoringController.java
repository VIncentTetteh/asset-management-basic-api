...
public class HealthMonitoringController {
    ...
    private final com.assetiq.repositories.AuditEventRepository auditEventRepository;

    public HealthMonitoringController(DataSource dataSource, com.assetiq.repositories.AuditEventRepository auditEventRepository) {
