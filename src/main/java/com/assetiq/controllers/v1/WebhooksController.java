...
public class WebhooksController {
    ...
    @PostMapping
    public ResponseEntity<WebhookDto> create(@Validated(OnCreate.class) @RequestBody WebhookDto dto) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<WebhookDto> update(@PathVariable UUID id, @Valid @RequestBody WebhookDto dto) {
