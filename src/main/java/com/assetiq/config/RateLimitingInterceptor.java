...
public class RateLimitingInterceptor implements HandlerInterceptor {
    ...
    public RateLimitingInterceptor(RateLimiter rateLimiter, RateLimitingConfig config) {
        this.ipResolver = new ClientIpResolver(config);
    ...
    /** True when {@code remoteAddr} is a configured trusted proxy (see {@link ClientIpResolver}). */
    private boolean isTrustedProxy(String remoteAddr) {
        return ipResolver.isTrustedProxy(remoteAddr);
    }
